...
- (void)viewDidLoad {
    ...
    [self setHTML:html];
//    self.enabledToolbarItems = @[YJRRichTextEditorToolbarNone];
//
...
//
//    // Custom image button
//    YJRBarButtonItem *item = [[YJRBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"RichImg/ZSSinsertkeyword.png" inBundle:YJBManager.defaultManager.currentBundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(didTapCustomToolbarButton:)];
